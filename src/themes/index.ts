...
export const themes = [
  ...
  { id: 'cosmic', name: 'Cosmic', className: 'theme-cosmic', accent: '#e056a0', font: "'Cormorant Garamond', serif", bg: '#030108' },
  { id: 'noir', name: 'Noir', className: 'theme-noir', accent: '#8b0000', font: "'Playfair Display', serif", bg: '#0a0a0a' },
